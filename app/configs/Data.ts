...
export const CODVID_DESCRIPTION = {
  1: 'กรุณากรอกข้อมูลประวัติส่วนตัว เพื่อใช้ในการคัดแยกความรุนแรง ผู้ป่วยที่มีความรุนแรงมากจะได้พบแพทย์อย่างรวดเร็ว',
  // 1: 'กรุณากรอกข้อมูลประวัติส่วนตัว เพื่อใช้ในการคัดแยกความรุนแรง ผู้ป่วยที่มีความรุนแรงมากจะได้พบแพทย์อย่างรวดเร็ว และคุณจะได้ยืมชุดการดูแลผู้ป่วย พร้อมได้รับยารักษาโรคโควิด 19 ฟรี',
  2: 'กรุณากรอกข้อมูลประวัติความเสี่ยงของคุณเพื่อใช้ในการคัดแยกระดับความเสี่ยงและพิจารณาการส่งเครื่องตรวจ ATK ให้กรอกแบบสอบถาม',
};
...
export const DATA_MENTAL_SURVEY = [
  {
    id: 0,
    lastName: 'ปกติดี',
    isAdd: false,
...
export const DATA_MENTAL_SURVEY_2 = [
  {
    id: 0,
    lastName: 'ปกติดี',
    isAdd: false,

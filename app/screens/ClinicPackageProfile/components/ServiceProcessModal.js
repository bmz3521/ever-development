    ...
    >
      ...
      <SafeAreaView style={baseStyles.modalBackground}>
        ...
        <View style={baseStyles.modalHeader}>
          ...
          <Text type="h5">Service Process</Text>
        </View>
        ...
        >
          {clinicPackage.serviceProcess && (
            <View style={baseStyles.sheetWrapper}>
              {clinicPackage?.serviceProcess.map((item, index) => {
                return (
                  <View key={index}>
                    <View
                      style={[
                        baseStyles.sheetRow,
                        {
                          backgroundColor: item.step % 2 != 0 ? '#EAF6F1' : '',
                        },
                      ]}
                    >

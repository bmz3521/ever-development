...
const ExampleHeaderAnimated: React.FC<any> = ({
    ...
    const _renderTabBar = (props: any) => {
        return <TabBar {...props} inactiveColor={'#333'} activeColor={'green'} style={styles.tabbarStyle} />
    }
    ...
    return (
        <View style={{
            ...
            backgroundColor: '#fff'
                ...
                renderLeft={() => {
                    return <Icon bold name="chevron-left" size={20} color='black' />;
                }}
                renderRight={() => {
                    return <Icon bold name="share" size={20} color='black' />;
                }}                onPressLeft={() => {
                    // navigation.goBack();
                }}
            />

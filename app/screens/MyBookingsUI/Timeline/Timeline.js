...
const Row = ({
  ...
  const title = titleIsComponent ? (
    ...
    !_isEmpty(OriginalTitle.content) && (
      <View>
    ...
    <FlatList
        ...
        <Row
          ...
          contentContainerStyle={[
            ...
            item.today.content
              ...
              : contentContainerStyle,
            item.status.content === 'isSame'
              ? [contentContainerStyle, { backgroundColor: '#1281ac' }]
              : contentContainerStyle,
            item.status.content === 'isBefore'
              ? [contentContainerStyle, { backgroundColor: '#eaeaea' }]
              : contentContainerStyle,
            item.status.content === 'isAfter'
              ? [contentContainerStyle, { backgroundColor: '#eaeaea' }]
              : contentContainerStyle,
          ]}
        />
      ...
      ListEmptyComponent={() => (
        ...
        >
          ...
          >
            {loading
              ? i18next.t('APPOINTMENTDETAIL_LOAD')
              : i18next.t('APPOINTMENTDETAIL_EMPTY')}
          </Text>
        </View>
      )}

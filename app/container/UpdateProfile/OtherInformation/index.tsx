...
import GenderItem from "app/patient-components/UpdateProfile/BasicInformation/GenderItem";
...
const genders = [
  {
    id: 1,
    title: "Male",
    icon: require("app/images/Icon/ic_male.png"),
  },
  {
    id: 0,
    title: "Female",
    icon: require("app/images/Icon/ic_female.png"),
  },
];
    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <InputApp
          ...
          iconLeft={
            <Image
              source={require("app/images/Icon/ic_pin_map.png")}
              style={Theme.icons}
            />
          }
          isShowIconLeft

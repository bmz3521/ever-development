...
import TextInputQuestion from "app/patient-components/TextInputQuestion";
import AdditionInfo from "app/patient-components/AdditionInfo";
import ButtonChangeCode from "app/patient-components/ButtonChangeCode";
...
//type
import { dataAddition, dataPerson } from "app/type/healthyQuestion";
...
import ModalChangePhoneCode from "app/patient-components/SignUp/ModalChangePhoneCode";
import ModalSlideBottom from "app/patient-components/ModalSlideBottom";
import ModalCondition from "app/patient-components/ModalCondition";
import ModalMenuOption from "app/patient-components/ModalMenuOption";
import ConnectionMethod from "app/patient-components/PrivateCareService/ConnectionMethod";
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <ConnectionMethod
          onPressChat={() => {
              navigate(Routes.PrivateCarePayment, { type: "app/typeLiveChat" });
          }}
          onPressVoiceCall={() => {
              navigate(Routes.PrivateCarePayment, { type: "app/typeCall" });
          }}
          onPressVideocall={() => {
              navigate(Routes.PrivateCarePayment, { type: "app/typeVideo" });
          }}
        />

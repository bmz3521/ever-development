...
import DialogInputCode from "app/patient-components/DialogInputCode";
import { Routes } from "app/configs";
import { payment } from "app/type/payment";
...
const PrivateCarePayment = memo(({ route }: any) => {
  ...
  const [icon, setIcon] = React.useState<string>("app/typeLiveChat");

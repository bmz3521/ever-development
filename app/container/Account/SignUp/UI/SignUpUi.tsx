    ...
    return (
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <InputApp
          ...
          icon={
            <Image
              source={require("app/images/Icon/ic_accept.png")}
              style={Theme.icons}
            />
          }
        />
        ...
        <InputApp
          ...
          icon={
            <Image
              source={require("app/images/Icon/ic_eye_on.png")}
              style={Theme.icons}
            />
          }
          isShowIcon
        ...
        <View style={styles.frameLoginSocial}>
          ...
          >
            <Image
              ...
              source={require("app/images/Icon/ic_facebook.png")}
            />
          ...
          >
            <Image
              style={{ width: scale(20), height: scale(20) }}
              source={require("app/images/Icon/ic_twitter.png")}
            />
            <Text type="H5" color={Colors.White} bold marginLeft={scale(10)}>
              Twitter
            </Text>

...
import SubtitleItem from "app/patient-components/Consults/SubtilteItem";
...
import AdditionalInformationQuestionItem from "app/patient-components/BookAppointment/AdditionalInformationQuestion";
...
import ModalChangeHealthData from "app/patient-components/ModalChangeHealthData";
...
import ModalAdditionalInformation from "app/patient-components/ModalAdditionalInformation";
          ...
          <ConnectionMethod
            onPressChat={() => {
              navigate(Routes.ServicesPayment, {
                type: "app/typeLiveChat",
              });
            }}
            onPressVoiceCall={() => {
              navigate(Routes.PrivateCarePayment, {
                type: "app/typeVoiceCall",
              });
            }}
            onPressVideocall={() => {
              navigate(Routes.ServicesPayment, { type: "app/typeVideoCall" });
            }}
          />
          <Text
            marginTop={16}
